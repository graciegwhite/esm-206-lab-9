...
#this is bad because price per sqft is calulated from dependant variable price. Biased overfitting of model results! 
homes_lm1
...
#overall, heteroscedasticity looks ok, residuals normality looks good, and conceptually and methemetically my model is making sense. 
```
...
#I would still pick homes_lm3 for the reasons described above 
